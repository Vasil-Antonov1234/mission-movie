                      ...
                      <div className={`${styles.field} ${styles.colSpan2}`}>
                        ...
                        <div className={styles.inputWrapper}>
                          <input
                            ...
                            className={`${styles.input} ${styles.inputWithIcon}${passwordErrors.currentPassword ? ` ${styles["input--error"]}` : ""}`}
                            placeholder="••••••••"
                        ...
                        {passwordErrors.currentPassword && <span className={styles.errorMsg}>{passwordErrors.currentPassword}</span>}
                      </div>
                      ...
                      <div className={styles.field}>
                        ...
                        <div className={styles.inputWrapper}>
                          <input
                            ...
                            className={`${styles.input} ${styles.inputWithIcon}${passwordErrors.newPassword ? ` ${styles["input--error"]}` : ""}`}
                        ...
                        {passwordErrors.newPassword && <span className={styles.errorMsg}>{passwordErrors.newPassword}</span>}
                      </div>
                      ...
                      <div className={styles.field}>
                        ...
                        <div className={styles.inputWrapper}>
                          <input
                            ...
                            className={`${styles.input} ${styles.inputWithIcon}${passwordErrors.confirmPassword ? ` ${styles["input--error"]}` : ""}`}
                        ...
                        {passwordErrors.confirmPassword && <span className={styles.errorMsg}>{passwordErrors.confirmPassword}</span>}
                      </div>
